<template>
  <header class="header">
    <div class="nav">
      <router-link to="/">
        <h3>Avinash Saxena</h3>
      </router-link>
      <nav class="navbar">
        <ul class="navbar-menu">
          <li class="navbar-menu__item">
            <router-link class="navbar-menu__link" :to="{ path: '/', hash: '#skills' }">
              Skills
            </router-link>
          </li>
          <li class="navbar-menu__item">
            <router-link class="navbar-menu__link" :to="{ path: '/', hash: '#experience' }">
              Experience
            </router-link>
          </li>
          <li class="navbar-menu__item">
            <router-link class="navbar-menu__link" :to="{ path: '/', hash: '#education' }">
              Education
            </router-link>
          </li>
          <li class="navbar-menu__item">
            <router-link class="navbar-menu__link" :to="{ path: '/', hash: '#projects' }">
              Projects
            </router-link>
          </li>
